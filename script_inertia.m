...
I_rocket_atCGtotal = I_rocket_noMotor + par_axis(M_rocket_with_no_motor, d_check_rocket);
...
%% --- Stampa risultati (formattazione migliorata) ------------------------
% Improved visual output with aligned columns, units removed for inertia tensors.
% Matrix printing enhanced with ASCII box lines.
...
info = struct( ...
    'm_rocket_noMotor',   M_rocket_with_no_motor, ...
...
% --- Local helper functions (kept minimal, in-file) ---------------------
